                ...
                {NAV_LINKS.map((item) => {
                  ...
                  return (
                    <li key={item.href}>
                      <Link
                        to={item.href}
                        className={`block whitespace-nowrap rounded-full px-2 py-1.5 text-[0.62rem] font-semibold transition sm:px-4.5 sm:py-2.5 sm:text-[0.83rem] lg:px-5 lg:py-2.5 lg:text-[0.88rem] ${
                          isActive
