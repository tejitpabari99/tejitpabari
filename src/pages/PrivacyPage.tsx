      ...
      <div className="mx-auto max-w-2xl space-y-8">
        ...
        <Section title="What this covers">
          <p>
            ...
            <code>/projects/&lt;slug&gt;/live</code>. Most projects and research items on this
            site instead link out to where they actually live, their own site, a GitHub
            repository, a published paper, an app or extension store listing, rather than being
            hosted on this domain itself. If a project of mine lives on its own domain, such as
            meetjuno.health for Juno, that project has its own privacy policy, and this page does
            not speak for it. Where that applies, I link to the project's own policy from its page
            here.
          </p>
          <p>
            <strong>This is a standing commitment, not a one-time fact.</strong> As I add new
            hosted pages under <code>/projects/*/live</code> or <code>/research/*/live</code>, one
            of them may eventually need to collect something this page does not currently
            describe, for example an input field. If that happens, I will update this page, and
            that project's own writeup, before the page goes live, not after. If you are reading
            this and a project you are using appears to ask for something this page does not
            describe, that is a gap in this page, not a hidden feature. Please email me (see
            Contact, below).
          </p>
        </Section>
