      ...
      <div className="mx-auto max-w-2xl space-y-8">
        ...
        <Section title="What this covers">
          <p>
            ...
            <code>/projects/&lt;slug&gt;/live</code>. Most project and research pages here instead
            link out to where each thing actually lives, rather than hosting it on this domain
            itself. A project hosted elsewhere, on its own domain or subdomain, is governed by
            that project's own terms, not this page.
          </p>
        </Section>
        ...
        <Section title="No forms, today">
          <p>
            ...
            not accept anything you submit. If a future page hosted here needs to change that, I
            will update this page, and that project's own page, before it ships, not after. See{' '}
