  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <input
        ...
        className="w-full rounded-full border border-teal-secondary/15 bg-cream px-5 py-3.5 text-base text-ink focus:border-teal-secondary/40 focus:outline-none sm:text-lg"
      />
